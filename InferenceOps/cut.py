...
class Cut:
    def __init__(self):
        ...
        self.modelTransf = load_model('Models/modeloCorte_66.h5')
        self.data = np.load('Datasets/Corte/MapsData_Corte_Derecha.npy') # MAPS
        self.target = np.load('Datasets/Corte/ClassData_Corte.npy') # Clases (0: experto, 1: intermedio, 2: novato)
