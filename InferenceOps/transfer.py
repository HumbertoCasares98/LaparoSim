...
class Transfer:
    def __init__(self):
        ...
        self.modelTransf = load_model('Models/modeloTransferencia_72.h5')
        self.data = np.load('Datasets/Transferencia/MapsData_Transferencia.npy') # MAPS
        self.target = np.load('Datasets/Transferencia/ClassData_Transferencia.npy') # Clases (0: experto, 1: intermedio, 2: novato)
